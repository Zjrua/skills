...
metadata:
  hermes:
    ...
    category: research
    related_skills: [arxiv, ml-paper-writing, subagent-driven-development, writing-plans]
...
| **writing-plans** | Phase 0 (Setup): creating structured plans before execution. Writes to `.hermes/plans/` | `skill_view("writing-plans")` |
